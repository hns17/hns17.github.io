...
categories: [Projects/WorkLog]
redirect_from:
  - "/daily/work/CubicCraft_GreedyMeshing/"
tags: ["Unity", "Project", "Voxel", "Block", "CubicCraft", "GreedyMeshing"]
---

> 핵심 요약
> - 이 글은 `CubicCraft - GreedyMeshing` 작업에서 진행한 내용을 기록한다.
