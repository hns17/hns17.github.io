...
redirect_from:
  - "/unity/external(asset/lib/etc)/UCSB/"
tags: ["Unity", "UCSB", "SpringBone", "UnityChanSpringBone", "JiggleBone", "Library"]

---

> 핵심 요약
> - 이 글은 `UnityChanSpringBone(UCSB) 소개` 기능이나 라이브러리의 사용 포인트를 정리한다.
