...
redirect_from:
  - "/unity/knowledge/Script-Optimization/"
tags: ["Unity", "Script", "Optimization", "Performance", "Memory"]
---

> 핵심 요약
> - 이 글은 `Unity Script Optimization` 주제의 최적화 포인트를 정리한다.
> - 무엇이 비용이 되고 어떤 선택이 유리한지 중심으로 본다.
> - 실무에서 바로 적용할 수 있는 기준을 함께 남긴다.
...
- LINQ를 사용할 경우 코드가 간결해지는 장점이 있지만 성능상 문제가 될 수 있다.
