...
- [ ] G002 — Lighting, Shading, Shadow는 무엇이 다른가
- [ ] G003 — 3D 장면에서 한 픽셀이 만들어지는 과정
- [ ] G004 — 현실의 빛과 실시간 렌더링의 타협

## 1부. 사람은 빛을 어떻게 이해하고 측정했는가

셰이딩과 그림자를 계산하기 전에 빛을 설명하고 측정하는 언어를 만든다.

- [ ] G005 — 빛은 무엇이며 그래픽스에서는 왜 광선으로 다루는가
- [ ] G006 — Newton의 프리즘 실험과 빛의 스펙트럼
- [ ] G007 — 반사, 굴절, 흡수와 산란
- [ ] G008 — Radiometry와 Photometry는 무엇이 다른가
- [ ] G009 — 입체각과 Steradian은 왜 필요한가
- [ ] G010 — Candela는 특정 방향의 빛을 어떻게 나타내는가
- [ ] G011 — Lumen은 광원의 전체 빛을 어떻게 나타내는가
- [ ] G012 — Lux와 거리 역제곱 법칙
- [ ] G013 — Luminance와 Nit는 보이는 밝기를 어떻게 나타내는가
- [ ] G014 — 광원의 크기, 색온도와 빛의 인상

## 2부. 빛은 어떻게 색과 이미지가 되는가

물리적인 빛이 사람의 시각과 디스플레이를 거쳐 RGB 이미지가 되는 과정을 다룬다.

- [ ] G015 — 사람의 눈은 빛을 어떻게 색으로 인식하는가
- [ ] G016 — 파장, 색 지각과 Metamerism
- [ ] G017 — RGB와 가산 혼합이 선택된 이유
- [ ] G018 — 감산 혼합은 가산 혼합과 무엇이 다른가
- [ ] G019 — CIE 색 일치 실험과 XYZ 색 공간
- [ ] G020 — 색역, White Point와 색도도
- [ ] G021 — sRGB와 Gamma Encoding의 역사
- [ ] G022 — Linear 공간에서 조명을 계산해야 하는 이유
- [ ] G023 — HDR, 카메라 노출과 EV
- [ ] G024 — Tone Mapping은 장면의 빛을 화면에 어떻게 담는가
