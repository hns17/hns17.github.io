...
기계, 우주선, 장비, 메카닉 중심의 그림을 모아보는 영역입니다.

{% assign items = site.clobie_art | where: 'clobie_type', 'mecha' | sort: 'date' | reverse %}
{% if items.size > 0 %}
...
{% else %}
<div class="clobie-empty">아직 등록된 메카 작업이 없습니다.</div>
{% endif %}
