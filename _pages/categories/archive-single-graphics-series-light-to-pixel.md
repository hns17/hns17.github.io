...
{% assign series_posts = site.categories[page.category_key] | sort: "series_order" | reverse %}
...
<div class="archive__lead" role="note" aria-label="연재 소개">
  ...
  <p class="archive__lead-meta">총 {{ series_posts | size }}개의 글 · 최신 글부터 표시 · 제목 번호는 읽기 순서</p>
</div>
